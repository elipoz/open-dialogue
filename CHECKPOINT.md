...
- **Agent replies:** Leading agent name (e.g. "Joshi: ") is stripped from model replies before store and display (`_strip_agent_name_prefix`) so the UI label is not duplicated.
